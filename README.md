...
Пакет реализует механизм валидации и фильтрации данных, а так же некоторые 
готовые решения для этого.
...
[исходные коды]: https://github.com/Bashka/bricks_validation/releases
[PHPUnit]: http://phpunit.de/
[обсуждение]: https://github.com/Bashka/bricks_validation/issues
